...
export function serializeForecast(
  ...
  return {
    ...
    priceBasisConfirmed: forecast.priceBasisConfirmed ?? null,
...
export function serializeCostEstimate(
  ...
  return {
    ...
    launchCashRequirement: estimate.launchCashRequirement ?? null,
    complianceCost: estimate.complianceCost ?? null,
    fulfillmentCostPerUnit: estimate.fulfillmentCostPerUnit ?? null,
    warrantyReservePct: estimate.warrantyReservePct ?? null,
